...
/* ---------------------------------------------------
 Structure of table "netobjects"
----------------------------------------------------*/
DROP SEQUENCE IF EXISTS netobjects_id_seq;
CREATE SEQUENCE netobjects_id_seq;
DROP TABLE IF EXISTS netobjects;
...
/* ---------------------------------------------------
 Structure of table "netcables"
----------------------------------------------------*/
DROP SEQUENCE IF EXISTS netcables_id_seq;
CREATE SEQUENCE netcables_id_seq;
DROP TABLE IF EXISTS netcables;
...
/* ---------------------------------------------------
 Structure of table "netsplices"
----------------------------------------------------*/
DROP SEQUENCE IF EXISTS netsplices_id_seq;
CREATE SEQUENCE netsplices_id_seq;
DROP TABLE IF EXISTS netsplices;
...
INSERT INTO dbinfo (keytype, keyvalue) VALUES ('dbversion', '2016012700');
