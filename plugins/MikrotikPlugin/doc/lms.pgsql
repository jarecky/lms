CREATE TABLE signals (
  date timestamp with timezone DEFAULT NULL,
  nodeid integer NOT NULL DEFAULT 0,
  netdev integer NOT NULL DEFAULT 0,
  channel smallint NOT NULL DEFAULT 0,
  software varchar(10) COLLATE utf8_polish_ci NOT NULL DEFAULT 0,
...
INSERT INTO uiconfig (section, var, value, description, disabled) VALUES (null,'mikrotik','password','admin','Hasło przy podłączaniu do Mikrotika',0);
